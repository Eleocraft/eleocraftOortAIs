...
impl Ship {
    ...
    pub fn tick(&mut self) {
        ...
        let aim_turning_angle = turning_angle * turning_angle * turning_angle * turning_angle * 4000.0;

        turn(f64::max(aim_turning_angle.abs(), projected_angular_speed.abs() * 1.7) * turning_angle.signum());
